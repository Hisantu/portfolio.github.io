...
void displayBorrowingRecords(const vector<BorrowingReturn>& borrowRecords);
void calculateFine(BorrowingReturn& record);
void checkLateReturns(const vector<BorrowingReturn>& borrowRecords);
void calculateLateFee(const vector<BorrowingReturn>& borrowRecords);
void deleteUser(vector<User>& users);
void displayOverdueBooks(const vector<BorrowingReturn>& borrowRecords);
void listBorrowedBooks(const vector<BorrowingReturn>& borrowRecords);
void checkIfBookIsOverdue(const vector<BorrowingReturn>& borrowRecords);
void reserveBook(vector<BorrowingReturn>& borrowRecords, int bookID, int userID);
void displayLateFeeDetails(const vector<BorrowingReturn>& borrowRecords, int borrowID);
*/
//Function prototypes
